...
public class PantallaLogin extends JFrame {
    ...
    private void init(){
        ...
        //Eqtiqueta de imagen
       ImageIcon Imagen = new ImageIcon("conmedlogo.PNG");
        ...
        jButtonIniciarSesion.addActionListener((ActionEvent e) -> {
                ...
                controlLoggin.validarLoggin(jTextClues.getText(), jPasswordContrasena.getText(), jTextCedulaProfesional.getText());
                if(validar){
